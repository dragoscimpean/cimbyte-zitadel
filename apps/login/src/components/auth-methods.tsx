...
const cardClasses = (alreadyAdded: boolean) =>
  clsx(
    "cb-card cb-card-compact cb-card-selectable group relative block space-y-1.5",
    alreadyAdded ? "is-disabled" : "cb-card-hover",
  );
  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      <div className="cb-card-title-row">
        <svg
          className="h-8 w-8 -translate-x-[2px] transform fill-current text-[var(--cb-ink-60)]"
        ...
        <span className="cb-card-title">Authenticator App</span>
      </div>
      {alreadyAdded && (
        <>
          <Setup />
    ...
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      <div className="cb-card-title-row">
        <svg
          ...
          strokeWidth="1.5"
          stroke="currentColor"
          className="h-8 w-8 text-[var(--cb-ink-60)]"
        >
          <path
            strokeLinecap="round"
        ...
        <span className="cb-card-title">Universal Second Factor</span>
      </div>
      {alreadyAdded && (
        <>
          <Setup />
  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      <div className="cb-card-title-row">
        ...
        <span className="cb-card-title">Code via Email</span>
      </div>
      {alreadyAdded && (
        <>
          <Setup />
  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      <div className="cb-card-title-row">
        ...
        <span className="cb-card-title">Code via SMS</span>
      </div>
      {alreadyAdded && (
        <>
          <Setup />
  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      <div className="cb-card-title-row">
        ...
        <span className="cb-card-title">Passkeys</span>
      </div>
      {alreadyAdded && (
        <>
          <Setup />
...
export const PASSWORD = (alreadyAdded: boolean, link: string) => {
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      <div className="cb-card-title-row">
        <svg className="h-7 w-8 fill-current text-[var(--cb-ink-60)]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <span className="cb-card-title">Password</span>
      </div>
      {alreadyAdded && (
        <>
          <Setup />
